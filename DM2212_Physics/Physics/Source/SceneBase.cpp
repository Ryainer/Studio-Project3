...
void SceneBase::Init()
{
	...
	meshList[GEO_ENEMYSHIP] = MeshBuilder::GenerateQuad("enemy", Color(1, 1, 1), 1.f);
	meshList[GEO_ENEMYSHIP]->textureID = LoadTGA("Image//enemyship.tga");

	meshList[GEO_ASTEROID] = MeshBuilder::GenerateQuad("Asteroid", Color(0, 0, 0), 1.f);
	meshList[GEO_ASTEROID]->textureID = LoadTGA("Image//Asteroids.tga");

	meshList[GEO_BLACKHOLE] = MeshBuilder::GenerateSphere("BlackHole", Color(1, 0, 0), 10, 10, 1.f);
	...
	meshList[GEO_BULLETSPRAY] = MeshBuilder::GenerateQuad("bulletspray", Color(0, 0, 0), 1.f);
	meshList[GEO_BULLETSPRAY]->textureID = LoadTGA("Image//BulletPack.tga");
	
	meshList[GEO_HEALTHRECOVER] = MeshBuilder::GenerateQuad("HealthRecover", Color(0, 0, 0), 1.f);
	meshList[GEO_HEALTHRECOVER]->textureID = LoadTGA("Image//Healthpack.tga");

	meshList[GEO_BOSS] = MeshBuilder::GenerateQuad("BossShip", Color(0, 0, 0), 1.f);
	meshList[GEO_BOSS]->textureID = LoadTGA("Image//BossShip.tga");

	meshList[GEO_BUDDYSHIP] = MeshBuilder::GenerateQuad("BuddyShip", Color(0, 0, 0), 1.f);
	meshList[GEO_BUDDYSHIP]->textureID = LoadTGA("Image//BuddyShip.tga");
	...
	meshList[GEO_RBC] = MeshBuilder::GenerateOBJ("sphere", "OBJ//TESTRBC.obj");
